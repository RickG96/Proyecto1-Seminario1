...
login = function() {
    ...
    axios.get('http://proyectobalancer-645258849.us-east-2.elb.amazonaws.com:3000/sesion/login?id=' + user)
        .then(response => {
...
registro = function() {
    ...
    if(password1 === password2) {
        ...
        axios.post('http://proyectobalancer-645258849.us-east-2.elb.amazonaws.com:3000/sesion/registro', {
                name: user,
                password: password1,
                base64: ""
            })
...
loginImagen = function(canvas) {
    axios.post('http://proyectobalancer-645258849.us-east-2.elb.amazonaws.com:3000/sesion/loginface', {
        image: canvas
    })
    .then(response => {
        console.log(response)
...
nuevoEstudiante = function() {
    ...
    if(idEstudiante != "" && imgBase64 != "") {
        axios.post('http://proyectobalancer-645258849.us-east-2.elb.amazonaws.com:3000/estudiante/registro', {
            id: idEstudiante,
            base64: imgBase64
        })
        .then(response => {
...
getEstudiantes = function() {
    axios.get('http://proyectobalancer-645258849.us-east-2.elb.amazonaws.com:3000/estudiante/listado')
        .then(res => {
